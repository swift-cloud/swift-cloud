...
extension S3 {
    ...
    internal enum AnalyticsS3ExportFileFormat: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
        case csv = "CSV"
    ...
    internal enum DeleteMarkerReplicationStatus: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
    ...
    internal enum ExistingObjectReplicationStatus: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
        case disabled = "Disabled"
        case enabled = "Enabled"
        internal var description: String { return self.rawValue }
    }
    ...
    internal enum IntelligentTieringAccessTier: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
        case archiveAccess = "ARCHIVE_ACCESS"
        case deepArchiveAccess = "DEEP_ARCHIVE_ACCESS"
        internal var description: String { return self.rawValue }
    }
    ...
    internal enum InventoryIncludedObjectVersions: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
        case all = "All"
    ...
    internal enum SseKmsEncryptedObjectsStatus: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
        case disabled = "Disabled"
        case enabled = "Enabled"
        internal var description: String { return self.rawValue }
    }
    ...
    internal enum StorageClassAnalysisSchemaVersion: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
        case v1 = "V_1"
        internal var description: String { return self.rawValue }
    }
    ...
    internal enum TransitionDefaultMinimumObjectSize: String, CustomStringConvertible, Codable, Sendable, CodingKeyRepresentable {
    ...
    internal struct AbortMultipartUploadRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, expectedBucketOwner: String? = nil, ifMatchInitiatedTime: Date? = nil, key: String, requestPayer: RequestPayer? = nil, uploadId: String) {
            self.bucket = bucket
    ...
    internal struct AnalyticsS3BucketDestination: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        internal init(bucket: String, bucketAccountId: String? = nil, format: AnalyticsS3ExportFileFormat, prefix: String? = nil) {
            self.bucket = bucket
    ...
    internal struct CORSRule: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        internal init(allowedHeaders: [String]? = nil, allowedMethods: [String], allowedOrigins: [String], exposeHeaders: [String]? = nil, id: String? = nil, maxAgeSeconds: Int? = nil) {
    ...
    internal struct CSVInput: AWSEncodableShape {
        ...
        @inlinable
        internal init(allowQuotedRecordDelimiter: Bool? = nil, comments: String? = nil, fieldDelimiter: String? = nil, fileHeaderInfo: FileHeaderInfo? = nil, quoteCharacter: String? = nil, quoteEscapeCharacter: String? = nil, recordDelimiter: String? = nil) {
    ...
    internal struct CSVOutput: AWSEncodableShape {
        ...
        @inlinable
        internal init(fieldDelimiter: String? = nil, quoteCharacter: String? = nil, quoteEscapeCharacter: String? = nil, quoteFields: QuoteFields? = nil, recordDelimiter: String? = nil) {
            self.fieldDelimiter = fieldDelimiter
            self.quoteCharacter = quoteCharacter
            self.quoteEscapeCharacter = quoteEscapeCharacter
    ...
    internal struct Checksum: AWSDecodableShape {
        ...
        @inlinable
        internal init(checksumCRC32: String? = nil, checksumCRC32C: String? = nil, checksumSHA1: String? = nil, checksumSHA256: String? = nil) {
    ...
    internal struct CompleteMultipartUploadOutput: AWSDecodableShape {
        ...
        @inlinable
        internal init(bucket: String? = nil, bucketKeyEnabled: Bool? = nil, checksumCRC32: String? = nil, checksumCRC32C: String? = nil, checksumSHA1: String? = nil, checksumSHA256: String? = nil, eTag: String? = nil, expiration: String? = nil, key: String? = nil, location: String? = nil, requestCharged: RequestCharged? = nil, serverSideEncryption: ServerSideEncryption? = nil, ssekmsKeyId: String? = nil, versionId: String? = nil) {
            self.bucket = bucket
    ...
    internal struct CompletedPart: AWSEncodableShape {
        ...
        @inlinable
        internal init(checksumCRC32: String? = nil, checksumCRC32C: String? = nil, checksumSHA1: String? = nil, checksumSHA256: String? = nil, eTag: String? = nil, partNumber: Int? = nil) {
            self.checksumCRC32 = checksumCRC32
            self.checksumCRC32C = checksumCRC32C
            self.checksumSHA1 = checksumSHA1
            self.checksumSHA256 = checksumSHA256
    ...
    internal struct CopyObjectResult: AWSDecodableShape {
        ...
        @inlinable
        internal init(checksumCRC32: String? = nil, checksumCRC32C: String? = nil, checksumSHA1: String? = nil, checksumSHA256: String? = nil, eTag: String? = nil, lastModified: Date? = nil) {
            self.checksumCRC32 = checksumCRC32
            self.checksumCRC32C = checksumCRC32C
            self.checksumSHA1 = checksumSHA1
            self.checksumSHA256 = checksumSHA256
    ...
    internal struct CreateBucketConfiguration: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: BucketInfo? = nil, location: LocationInfo? = nil, locationConstraint: BucketLocationConstraint? = nil) {
            self.bucket = bucket
            self.location = location
    ...
    internal struct CreateBucketMetadataTableConfigurationRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, checksumAlgorithm: ChecksumAlgorithm? = nil, contentMD5: String? = nil, expectedBucketOwner: String? = nil, metadataTableConfiguration: MetadataTableConfiguration) {
            self.bucket = bucket
            self.checksumAlgorithm = checksumAlgorithm
    ...
    internal struct CreateBucketRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(acl: BucketCannedACL? = nil, bucket: String, createBucketConfiguration: CreateBucketConfiguration? = nil, grantFullControl: String? = nil, grantRead: String? = nil, grantReadACP: String? = nil, grantWrite: String? = nil, grantWriteACP: String? = nil, objectLockEnabledForBucket: Bool? = nil, objectOwnership: ObjectOwnership? = nil) {
            self.acl = acl
            self.bucket = bucket
    ...
    internal struct CreateSessionOutput: AWSDecodableShape {
        ...
        @inlinable
        internal init(bucketKeyEnabled: Bool? = nil, credentials: SessionCredentials, serverSideEncryption: ServerSideEncryption? = nil, ssekmsEncryptionContext: String? = nil, ssekmsKeyId: String? = nil) {
            self.bucketKeyEnabled = bucketKeyEnabled
    ...
    internal struct CreateSessionRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, bucketKeyEnabled: Bool? = nil, serverSideEncryption: ServerSideEncryption? = nil, sessionMode: SessionMode? = nil, ssekmsEncryptionContext: String? = nil, ssekmsKeyId: String? = nil) {
            self.bucket = bucket
            self.bucketKeyEnabled = bucketKeyEnabled
            self.serverSideEncryption = serverSideEncryption
    ...
    internal struct DeleteMarkerEntry: AWSDecodableShape {
        ...
        @inlinable
        internal init(isLatest: Bool? = nil, key: String? = nil, lastModified: Date? = nil, owner: Owner? = nil, versionId: String? = nil) {
    ...
    internal struct DeleteObjectRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, bypassGovernanceRetention: Bool? = nil, expectedBucketOwner: String? = nil, ifMatch: String? = nil, ifMatchLastModifiedTime: Date? = nil, ifMatchSize: Int64? = nil, key: String, mfa: String? = nil, requestPayer: RequestPayer? = nil, versionId: String? = nil) {
            self.bucket = bucket
    ...
    internal struct DeleteObjectsRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, bypassGovernanceRetention: Bool? = nil, checksumAlgorithm: ChecksumAlgorithm? = nil, delete: Delete, expectedBucketOwner: String? = nil, mfa: String? = nil, requestPayer: RequestPayer? = nil) {
            self.bucket = bucket
            self.bypassGovernanceRetention = bypassGovernanceRetention
            self.checksumAlgorithm = checksumAlgorithm
            self.delete = delete
    ...
    internal struct DeletedObject: AWSDecodableShape {
        ...
        @inlinable
        internal init(deleteMarker: Bool? = nil, deleteMarkerVersionId: String? = nil, key: String? = nil, versionId: String? = nil) {
            self.deleteMarker = deleteMarker
    ...
    internal struct Destination: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        internal init(accessControlTranslation: AccessControlTranslation? = nil, account: String? = nil, bucket: String, encryptionConfiguration: EncryptionConfiguration? = nil, metrics: Metrics? = nil, replicationTime: ReplicationTime? = nil, storageClass: StorageClass? = nil) {
    ...
    internal struct GetBucketLifecycleConfigurationOutput: AWSDecodableShape {
        ...
        @inlinable
        internal init(rules: [LifecycleRule]? = nil, transitionDefaultMinimumObjectSize: TransitionDefaultMinimumObjectSize? = nil) {
            self.rules = rules
    ...
    internal struct GetBucketMetadataTableConfigurationResult: AWSDecodableShape {
        ...
        @inlinable
        internal init(error: ErrorDetails? = nil, metadataTableConfigurationResult: MetadataTableConfigurationResult, status: String) {
            self.error = error
    ...
    internal struct GetBucketWebsiteOutput: AWSDecodableShape {
        ...
        @inlinable
        internal init(errorDocument: ErrorDocument? = nil, indexDocument: IndexDocument? = nil, redirectAllRequestsTo: RedirectAllRequestsTo? = nil, routingRules: [RoutingRule]? = nil) {
    ...
    internal struct GetObjectAclRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, expectedBucketOwner: String? = nil, key: String, requestPayer: RequestPayer? = nil, versionId: String? = nil) {
            self.bucket = bucket
            self.expectedBucketOwner = expectedBucketOwner
            self.key = key
            self.requestPayer = requestPayer
    ...
    internal struct GetObjectAttributesOutput: AWSDecodableShape {
        ...
        @inlinable
        internal init(checksum: Checksum? = nil, deleteMarker: Bool? = nil, eTag: String? = nil, lastModified: Date? = nil, objectParts: GetObjectAttributesParts? = nil, objectSize: Int64? = nil, requestCharged: RequestCharged? = nil, storageClass: StorageClass? = nil, versionId: String? = nil) {
    ...
    internal struct GetObjectAttributesParts: AWSDecodableShape {
        ...
        @inlinable
        internal init(isTruncated: Bool? = nil, maxParts: Int? = nil, nextPartNumberMarker: String? = nil, partNumberMarker: String? = nil, parts: [ObjectPart]? = nil, totalPartsCount: Int? = nil) {
    ...
    internal struct GetObjectAttributesRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, expectedBucketOwner: String? = nil, key: String, maxParts: Int? = nil, objectAttributes: [ObjectAttributes], partNumberMarker: String? = nil, requestPayer: RequestPayer? = nil, sseCustomerAlgorithm: String? = nil, sseCustomerKey: String? = nil, sseCustomerKeyMD5: String? = nil, versionId: String? = nil) {
            self.bucket = bucket
            self.expectedBucketOwner = expectedBucketOwner
            self.key = key
            self.maxParts = maxParts
    ...
    internal struct GetObjectTorrentRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, expectedBucketOwner: String? = nil, key: String, requestPayer: RequestPayer? = nil) {
            self.bucket = bucket
            self.expectedBucketOwner = expectedBucketOwner
            self.key = key
            self.requestPayer = requestPayer
    ...
    internal struct Grantee: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        internal init(displayName: String? = nil, emailAddress: String? = nil, id: String? = nil, type: `Type`, uri: String? = nil) {
    ...
    internal struct HeadBucketOutput: AWSDecodableShape {
        ...
        @inlinable
        internal init(accessPointAlias: Bool? = nil, bucketLocationName: String? = nil, bucketLocationType: LocationType? = nil, bucketRegion: String? = nil) {
    ...
    internal struct HeadObjectOutput: AWSDecodableShape {
        ...
        @inlinable
        internal init(acceptRanges: String? = nil, archiveStatus: ArchiveStatus? = nil, bucketKeyEnabled: Bool? = nil, cacheControl: String? = nil, checksumCRC32: String? = nil, checksumCRC32C: String? = nil, checksumSHA1: String? = nil, checksumSHA256: String? = nil, contentDisposition: String? = nil, contentEncoding: String? = nil, contentLanguage: String? = nil, contentLength: Int64? = nil, contentType: String? = nil, deleteMarker: Bool? = nil, eTag: String? = nil, expiration: String? = nil, expires: Date? = nil, lastModified: Date? = nil, metadata: [String: String]? = nil, missingMeta: Int? = nil, objectLockLegalHoldStatus: ObjectLockLegalHoldStatus? = nil, objectLockMode: ObjectLockMode? = nil, objectLockRetainUntilDate: Date? = nil, partsCount: Int? = nil, replicationStatus: ReplicationStatus? = nil, requestCharged: RequestCharged? = nil, restore: String? = nil, serverSideEncryption: ServerSideEncryption? = nil, sseCustomerAlgorithm: String? = nil, sseCustomerKeyMD5: String? = nil, ssekmsKeyId: String? = nil, storageClass: StorageClass? = nil, versionId: String? = nil, websiteRedirectLocation: String? = nil) {
            self.acceptRanges = acceptRanges
    ...
    internal struct InputSerialization: AWSEncodableShape {
        ...
        @inlinable
        internal init(compressionType: CompressionType? = nil, csv: CSVInput? = nil, json: JSONInput? = nil, parquet: ParquetInput? = nil) {
    ...
    internal struct IntelligentTieringConfiguration: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        internal init(filter: IntelligentTieringFilter? = nil, id: String, status: IntelligentTieringStatus, tierings: [Tiering]) {
            self.filter = filter
            self.id = id
            self.status = status
    ...
    internal struct InventoryConfiguration: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        internal init(destination: InventoryDestination, filter: InventoryFilter? = nil, id: String, includedObjectVersions: InventoryIncludedObjectVersions, isEnabled: Bool, optionalFields: [InventoryOptionalField]? = nil, schedule: InventorySchedule) {
    ...
    internal struct InventoryS3BucketDestination: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        internal init(accountId: String? = nil, bucket: String, encryption: InventoryEncryption? = nil, format: InventoryFormat, prefix: String? = nil) {
    ...
    internal struct LambdaFunctionConfiguration: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        internal init(events: [Event], filter: NotificationConfigurationFilter? = nil, id: String? = nil, lambdaFunctionArn: String) {
            self.events = events
            self.filter = filter
            self.id = id
    ...
    internal struct LifecycleRuleAndOperator: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        internal init(objectSizeGreaterThan: Int64? = nil, objectSizeLessThan: Int64? = nil, prefix: String? = nil, tags: [Tag]? = nil) {
    ...
    internal struct LifecycleRuleFilter: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        internal init(and: LifecycleRuleAndOperator? = nil, objectSizeGreaterThan: Int64? = nil, objectSizeLessThan: Int64? = nil, prefix: String? = nil, tag: Tag? = nil) {
            self.and = and
            self.objectSizeGreaterThan = objectSizeGreaterThan
            self.objectSizeLessThan = objectSizeLessThan
            self.prefix = prefix
    ...
    internal struct ListBucketAnalyticsConfigurationsOutput: AWSDecodableShape {
        ...
        @inlinable
        internal init(analyticsConfigurationList: [AnalyticsConfiguration]? = nil, continuationToken: String? = nil, isTruncated: Bool? = nil, nextContinuationToken: String? = nil) {
    ...
    internal struct ListBucketIntelligentTieringConfigurationsOutput: AWSDecodableShape {
        ...
        @inlinable
        internal init(continuationToken: String? = nil, intelligentTieringConfigurationList: [IntelligentTieringConfiguration]? = nil, isTruncated: Bool? = nil, nextContinuationToken: String? = nil) {
            self.continuationToken = continuationToken
    ...
    internal struct ListBucketInventoryConfigurationsOutput: AWSDecodableShape {
        ...
        @inlinable
        internal init(continuationToken: String? = nil, inventoryConfigurationList: [InventoryConfiguration]? = nil, isTruncated: Bool? = nil, nextContinuationToken: String? = nil) {
            self.continuationToken = continuationToken
    ...
    internal struct ListBucketMetricsConfigurationsOutput: AWSDecodableShape {
        ...
        @inlinable
        internal init(continuationToken: String? = nil, isTruncated: Bool? = nil, metricsConfigurationList: [MetricsConfiguration]? = nil, nextContinuationToken: String? = nil) {
            self.continuationToken = continuationToken
            self.isTruncated = isTruncated
    ...
    internal struct ListBucketsOutput: AWSDecodableShape {
        ...
        @inlinable
        internal init(buckets: [Bucket]? = nil, continuationToken: String? = nil, owner: Owner? = nil, prefix: String? = nil) {
    ...
    internal struct ListBucketsRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucketRegion: String? = nil, continuationToken: String? = nil, maxBuckets: Int? = nil, prefix: String? = nil) {
            self.bucketRegion = bucketRegion
            self.continuationToken = continuationToken
    ...
    internal struct ListMultipartUploadsRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, delimiter: String? = nil, encodingType: EncodingType? = nil, expectedBucketOwner: String? = nil, keyMarker: String? = nil, maxUploads: Int? = nil, prefix: String? = nil, requestPayer: RequestPayer? = nil, uploadIdMarker: String? = nil) {
            self.bucket = bucket
            self.delimiter = delimiter
            self.encodingType = encodingType
            self.expectedBucketOwner = expectedBucketOwner
    ...
    internal struct ListObjectVersionsRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, delimiter: String? = nil, encodingType: EncodingType? = nil, expectedBucketOwner: String? = nil, keyMarker: String? = nil, maxKeys: Int? = nil, optionalObjectAttributes: [OptionalObjectAttributes]? = nil, prefix: String? = nil, requestPayer: RequestPayer? = nil, versionIdMarker: String? = nil) {
            self.bucket = bucket
            self.delimiter = delimiter
            self.encodingType = encodingType
            self.expectedBucketOwner = expectedBucketOwner
    ...
    internal struct ListObjectsOutput: AWSDecodableShape {
        ...
        @inlinable
        internal init(commonPrefixes: [CommonPrefix]? = nil, contents: [Object]? = nil, delimiter: String? = nil, encodingType: EncodingType? = nil, isTruncated: Bool? = nil, marker: String? = nil, maxKeys: Int? = nil, name: String? = nil, nextMarker: String? = nil, prefix: String? = nil, requestCharged: RequestCharged? = nil) {
            self.commonPrefixes = commonPrefixes
    ...
    internal struct ListObjectsRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, delimiter: String? = nil, encodingType: EncodingType? = nil, expectedBucketOwner: String? = nil, marker: String? = nil, maxKeys: Int? = nil, optionalObjectAttributes: [OptionalObjectAttributes]? = nil, prefix: String? = nil, requestPayer: RequestPayer? = nil) {
            self.bucket = bucket
            self.delimiter = delimiter
            self.encodingType = encodingType
            self.expectedBucketOwner = expectedBucketOwner
    ...
    internal struct ListObjectsV2Request: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, continuationToken: String? = nil, delimiter: String? = nil, encodingType: EncodingType? = nil, expectedBucketOwner: String? = nil, fetchOwner: Bool? = nil, maxKeys: Int? = nil, optionalObjectAttributes: [OptionalObjectAttributes]? = nil, prefix: String? = nil, requestPayer: RequestPayer? = nil, startAfter: String? = nil) {
            self.bucket = bucket
            self.continuationToken = continuationToken
            self.delimiter = delimiter
            self.encodingType = encodingType
    ...
    internal struct ListPartsRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, expectedBucketOwner: String? = nil, key: String, maxParts: Int? = nil, partNumberMarker: String? = nil, requestPayer: RequestPayer? = nil, sseCustomerAlgorithm: String? = nil, sseCustomerKey: String? = nil, sseCustomerKeyMD5: String? = nil, uploadId: String) {
            self.bucket = bucket
            self.expectedBucketOwner = expectedBucketOwner
            self.key = key
            self.maxParts = maxParts
    ...
    internal struct LoggingEnabled: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        internal init(targetBucket: String, targetGrants: [TargetGrant]? = nil, targetObjectKeyFormat: TargetObjectKeyFormat? = nil, targetPrefix: String) {
    ...
    internal struct MultipartUpload: AWSDecodableShape {
        ...
        @inlinable
        internal init(checksumAlgorithm: ChecksumAlgorithm? = nil, initiated: Date? = nil, initiator: Initiator? = nil, key: String? = nil, owner: Owner? = nil, storageClass: StorageClass? = nil, uploadId: String? = nil) {
            self.checksumAlgorithm = checksumAlgorithm
    ...
    internal struct NoncurrentVersionTransition: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        internal init(newerNoncurrentVersions: Int? = nil, noncurrentDays: Int? = nil, storageClass: TransitionStorageClass? = nil) {
            self.newerNoncurrentVersions = newerNoncurrentVersions
            self.noncurrentDays = noncurrentDays
            self.storageClass = storageClass
        }
    ...
    internal struct NotificationConfiguration: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        internal init(eventBridgeConfiguration: EventBridgeConfiguration? = nil, lambdaFunctionConfigurations: [LambdaFunctionConfiguration]? = nil, queueConfigurations: [QueueConfiguration]? = nil, topicConfigurations: [TopicConfiguration]? = nil) {
    ...
    internal struct Object: AWSDecodableShape {
        ...
        @inlinable
        internal init(checksumAlgorithm: [ChecksumAlgorithm]? = nil, eTag: String? = nil, key: String? = nil, lastModified: Date? = nil, owner: Owner? = nil, restoreStatus: RestoreStatus? = nil, size: Int64? = nil, storageClass: ObjectStorageClass? = nil) {
            self.checksumAlgorithm = checksumAlgorithm
            self.eTag = eTag
            self.key = key
            self.lastModified = lastModified
    ...
    internal struct ObjectIdentifier: AWSEncodableShape {
        ...
        @inlinable
        internal init(eTag: String? = nil, key: String, lastModifiedTime: Date? = nil, size: Int64? = nil, versionId: String? = nil) {
            self.eTag = eTag
            self.key = key
    ...
    internal struct ObjectPart: AWSDecodableShape {
        ...
        @inlinable
        internal init(checksumCRC32: String? = nil, checksumCRC32C: String? = nil, checksumSHA1: String? = nil, checksumSHA256: String? = nil, partNumber: Int? = nil, size: Int64? = nil) {
            self.checksumCRC32 = checksumCRC32
            self.checksumCRC32C = checksumCRC32C
            self.checksumSHA1 = checksumSHA1
            self.checksumSHA256 = checksumSHA256
    ...
    internal struct ObjectVersion: AWSDecodableShape {
        ...
        @inlinable
        internal init(checksumAlgorithm: [ChecksumAlgorithm]? = nil, eTag: String? = nil, isLatest: Bool? = nil, key: String? = nil, lastModified: Date? = nil, owner: Owner? = nil, restoreStatus: RestoreStatus? = nil, size: Int64? = nil, storageClass: ObjectVersionStorageClass? = nil, versionId: String? = nil) {
            self.checksumAlgorithm = checksumAlgorithm
            self.eTag = eTag
            self.isLatest = isLatest
            self.key = key
    ...
    internal struct Part: AWSDecodableShape {
        ...
        @inlinable
        internal init(checksumCRC32: String? = nil, checksumCRC32C: String? = nil, checksumSHA1: String? = nil, checksumSHA256: String? = nil, eTag: String? = nil, lastModified: Date? = nil, partNumber: Int? = nil, size: Int64? = nil) {
            self.checksumCRC32 = checksumCRC32
            self.checksumCRC32C = checksumCRC32C
            self.checksumSHA1 = checksumSHA1
            self.checksumSHA256 = checksumSHA256
    ...
    internal struct PublicAccessBlockConfiguration: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        internal init(blockPublicAcls: Bool? = nil, blockPublicPolicy: Bool? = nil, ignorePublicAcls: Bool? = nil, restrictPublicBuckets: Bool? = nil) {
    ...
    internal struct PutBucketAccelerateConfigurationRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(accelerateConfiguration: AccelerateConfiguration, bucket: String, checksumAlgorithm: ChecksumAlgorithm? = nil, expectedBucketOwner: String? = nil) {
    ...
    internal struct PutBucketAclRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(accessControlPolicy: AccessControlPolicy? = nil, acl: BucketCannedACL? = nil, bucket: String, checksumAlgorithm: ChecksumAlgorithm? = nil, contentMD5: String? = nil, expectedBucketOwner: String? = nil, grantFullControl: String? = nil, grantRead: String? = nil, grantReadACP: String? = nil, grantWrite: String? = nil, grantWriteACP: String? = nil) {
    ...
    internal struct PutBucketAnalyticsConfigurationRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(analyticsConfiguration: AnalyticsConfiguration, bucket: String, expectedBucketOwner: String? = nil, id: String) {
            self.analyticsConfiguration = analyticsConfiguration
            self.bucket = bucket
            self.expectedBucketOwner = expectedBucketOwner
            self.id = id
    ...
    internal struct PutBucketCorsRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, checksumAlgorithm: ChecksumAlgorithm? = nil, contentMD5: String? = nil, corsConfiguration: CORSConfiguration, expectedBucketOwner: String? = nil) {
            self.bucket = bucket
            self.checksumAlgorithm = checksumAlgorithm
            self.contentMD5 = contentMD5
    ...
    internal struct PutBucketEncryptionRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, checksumAlgorithm: ChecksumAlgorithm? = nil, contentMD5: String? = nil, expectedBucketOwner: String? = nil, serverSideEncryptionConfiguration: ServerSideEncryptionConfiguration) {
            self.bucket = bucket
            self.checksumAlgorithm = checksumAlgorithm
            self.contentMD5 = contentMD5
            self.expectedBucketOwner = expectedBucketOwner
    ...
    internal struct PutBucketInventoryConfigurationRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, expectedBucketOwner: String? = nil, id: String, inventoryConfiguration: InventoryConfiguration) {
            self.bucket = bucket
            self.expectedBucketOwner = expectedBucketOwner
            self.id = id
            self.inventoryConfiguration = inventoryConfiguration
    ...
    internal struct PutBucketLifecycleConfigurationRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, checksumAlgorithm: ChecksumAlgorithm? = nil, expectedBucketOwner: String? = nil, lifecycleConfiguration: BucketLifecycleConfiguration? = nil, transitionDefaultMinimumObjectSize: TransitionDefaultMinimumObjectSize? = nil) {
            self.bucket = bucket
            self.checksumAlgorithm = checksumAlgorithm
            self.expectedBucketOwner = expectedBucketOwner
    ...
    internal struct PutBucketLoggingRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, bucketLoggingStatus: BucketLoggingStatus, checksumAlgorithm: ChecksumAlgorithm? = nil, contentMD5: String? = nil, expectedBucketOwner: String? = nil) {
            self.bucket = bucket
    ...
    internal struct PutBucketMetricsConfigurationRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, expectedBucketOwner: String? = nil, id: String, metricsConfiguration: MetricsConfiguration) {
            self.bucket = bucket
            self.expectedBucketOwner = expectedBucketOwner
            self.id = id
            self.metricsConfiguration = metricsConfiguration
    ...
    internal struct PutBucketNotificationConfigurationRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, expectedBucketOwner: String? = nil, notificationConfiguration: NotificationConfiguration, skipDestinationValidation: Bool? = nil) {
            self.bucket = bucket
            self.expectedBucketOwner = expectedBucketOwner
    ...
    internal struct PutBucketOwnershipControlsRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, contentMD5: String? = nil, expectedBucketOwner: String? = nil, ownershipControls: OwnershipControls) {
            self.bucket = bucket
            self.contentMD5 = contentMD5
            self.expectedBucketOwner = expectedBucketOwner
            self.ownershipControls = ownershipControls
    ...
    internal struct PutBucketPolicyRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, checksumAlgorithm: ChecksumAlgorithm? = nil, confirmRemoveSelfBucketAccess: Bool? = nil, contentMD5: String? = nil, expectedBucketOwner: String? = nil, policy: String) {
            self.bucket = bucket
            self.checksumAlgorithm = checksumAlgorithm
    ...
    internal struct PutBucketReplicationRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, checksumAlgorithm: ChecksumAlgorithm? = nil, contentMD5: String? = nil, expectedBucketOwner: String? = nil, replicationConfiguration: ReplicationConfiguration, token: String? = nil) {
            self.bucket = bucket
            self.checksumAlgorithm = checksumAlgorithm
            self.contentMD5 = contentMD5
            self.expectedBucketOwner = expectedBucketOwner
    ...
    internal struct PutBucketRequestPaymentRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, checksumAlgorithm: ChecksumAlgorithm? = nil, contentMD5: String? = nil, expectedBucketOwner: String? = nil, requestPaymentConfiguration: RequestPaymentConfiguration) {
            self.bucket = bucket
            self.checksumAlgorithm = checksumAlgorithm
            self.contentMD5 = contentMD5
            self.expectedBucketOwner = expectedBucketOwner
    ...
    internal struct PutBucketTaggingRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, checksumAlgorithm: ChecksumAlgorithm? = nil, contentMD5: String? = nil, expectedBucketOwner: String? = nil, tagging: Tagging) {
            self.bucket = bucket
            self.checksumAlgorithm = checksumAlgorithm
            self.contentMD5 = contentMD5
            self.expectedBucketOwner = expectedBucketOwner
    ...
    internal struct PutBucketVersioningRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, checksumAlgorithm: ChecksumAlgorithm? = nil, contentMD5: String? = nil, expectedBucketOwner: String? = nil, mfa: String? = nil, versioningConfiguration: VersioningConfiguration) {
            self.bucket = bucket
            self.checksumAlgorithm = checksumAlgorithm
            self.contentMD5 = contentMD5
            self.expectedBucketOwner = expectedBucketOwner
    ...
    internal struct PutBucketWebsiteRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, checksumAlgorithm: ChecksumAlgorithm? = nil, contentMD5: String? = nil, expectedBucketOwner: String? = nil, websiteConfiguration: WebsiteConfiguration) {
            self.bucket = bucket
            self.checksumAlgorithm = checksumAlgorithm
            self.contentMD5 = contentMD5
            self.expectedBucketOwner = expectedBucketOwner
    ...
    internal struct PutObjectAclRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(accessControlPolicy: AccessControlPolicy? = nil, acl: ObjectCannedACL? = nil, bucket: String, checksumAlgorithm: ChecksumAlgorithm? = nil, contentMD5: String? = nil, expectedBucketOwner: String? = nil, grantFullControl: String? = nil, grantRead: String? = nil, grantReadACP: String? = nil, grantWrite: String? = nil, grantWriteACP: String? = nil, key: String, requestPayer: RequestPayer? = nil, versionId: String? = nil) {
            self.accessControlPolicy = accessControlPolicy
            self.acl = acl
            self.bucket = bucket
            self.checksumAlgorithm = checksumAlgorithm
    ...
    internal struct PutObjectLegalHoldRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, checksumAlgorithm: ChecksumAlgorithm? = nil, contentMD5: String? = nil, expectedBucketOwner: String? = nil, key: String, legalHold: ObjectLockLegalHold? = nil, requestPayer: RequestPayer? = nil, versionId: String? = nil) {
            self.bucket = bucket
            self.checksumAlgorithm = checksumAlgorithm
            self.contentMD5 = contentMD5
            self.expectedBucketOwner = expectedBucketOwner
    ...
    internal struct PutObjectLockConfigurationRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, checksumAlgorithm: ChecksumAlgorithm? = nil, contentMD5: String? = nil, expectedBucketOwner: String? = nil, objectLockConfiguration: ObjectLockConfiguration? = nil, requestPayer: RequestPayer? = nil, token: String? = nil) {
            self.bucket = bucket
            self.checksumAlgorithm = checksumAlgorithm
            self.contentMD5 = contentMD5
            self.expectedBucketOwner = expectedBucketOwner
    ...
    internal struct PutObjectOutput: AWSDecodableShape {
        ...
        @inlinable
        internal init(bucketKeyEnabled: Bool? = nil, checksumCRC32: String? = nil, checksumCRC32C: String? = nil, checksumSHA1: String? = nil, checksumSHA256: String? = nil, eTag: String? = nil, expiration: String? = nil, requestCharged: RequestCharged? = nil, serverSideEncryption: ServerSideEncryption? = nil, size: Int64? = nil, sseCustomerAlgorithm: String? = nil, sseCustomerKeyMD5: String? = nil, ssekmsEncryptionContext: String? = nil, ssekmsKeyId: String? = nil, versionId: String? = nil) {
            self.bucketKeyEnabled = bucketKeyEnabled
            self.checksumCRC32 = checksumCRC32
            self.checksumCRC32C = checksumCRC32C
            self.checksumSHA1 = checksumSHA1
    ...
    internal struct PutObjectRetentionRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, bypassGovernanceRetention: Bool? = nil, checksumAlgorithm: ChecksumAlgorithm? = nil, contentMD5: String? = nil, expectedBucketOwner: String? = nil, key: String, requestPayer: RequestPayer? = nil, retention: ObjectLockRetention? = nil, versionId: String? = nil) {
            self.bucket = bucket
            self.bypassGovernanceRetention = bypassGovernanceRetention
            self.checksumAlgorithm = checksumAlgorithm
            self.contentMD5 = contentMD5
    ...
    internal struct PutObjectTaggingRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, checksumAlgorithm: ChecksumAlgorithm? = nil, contentMD5: String? = nil, expectedBucketOwner: String? = nil, key: String, requestPayer: RequestPayer? = nil, tagging: Tagging, versionId: String? = nil) {
            self.bucket = bucket
            self.checksumAlgorithm = checksumAlgorithm
            self.contentMD5 = contentMD5
            self.expectedBucketOwner = expectedBucketOwner
    ...
    internal struct PutPublicAccessBlockRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, checksumAlgorithm: ChecksumAlgorithm? = nil, contentMD5: String? = nil, expectedBucketOwner: String? = nil, publicAccessBlockConfiguration: PublicAccessBlockConfiguration) {
            self.bucket = bucket
            self.checksumAlgorithm = checksumAlgorithm
            self.contentMD5 = contentMD5
            self.expectedBucketOwner = expectedBucketOwner
    ...
    internal struct QueueConfiguration: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        internal init(events: [Event], filter: NotificationConfigurationFilter? = nil, id: String? = nil, queueArn: String) {
            self.events = events
            self.filter = filter
            self.id = id
    ...
    internal struct Redirect: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        internal init(hostName: String? = nil, httpRedirectCode: String? = nil, protocol: `Protocol`? = nil, replaceKeyPrefixWith: String? = nil, replaceKeyWith: String? = nil) {
    ...
    internal struct ReplicationRule: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        internal init(deleteMarkerReplication: DeleteMarkerReplication? = nil, destination: Destination, existingObjectReplication: ExistingObjectReplication? = nil, filter: ReplicationRuleFilter? = nil, id: String? = nil, priority: Int? = nil, sourceSelectionCriteria: SourceSelectionCriteria? = nil, status: ReplicationRuleStatus) {
    ...
    internal struct RestoreObjectRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(bucket: String, checksumAlgorithm: ChecksumAlgorithm? = nil, expectedBucketOwner: String? = nil, key: String, requestPayer: RequestPayer? = nil, restoreRequest: RestoreRequest? = nil, versionId: String? = nil) {
            self.bucket = bucket
            self.checksumAlgorithm = checksumAlgorithm
            self.expectedBucketOwner = expectedBucketOwner
            self.key = key
    ...
    internal struct RestoreRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(days: Int? = nil, description: String? = nil, glacierJobParameters: GlacierJobParameters? = nil, outputLocation: OutputLocation? = nil, selectParameters: SelectParameters? = nil, tier: Tier? = nil, type: RestoreRequestType? = nil) {
            self.days = days
    ...
    internal struct S3Location: AWSEncodableShape {
        ...
        @inlinable
        internal init(accessControlList: [Grant]? = nil, bucketName: String, cannedACL: ObjectCannedACL? = nil, encryption: Encryption? = nil, prefix: String, storageClass: StorageClass? = nil, tagging: Tagging? = nil, userMetadata: [MetadataEntry]? = nil) {
    ...
    internal struct SelectParameters: AWSEncodableShape {
        ...
        @inlinable
        internal init(expression: String, expressionType: ExpressionType, inputSerialization: InputSerialization, outputSerialization: OutputSerialization) {
            self.expression = expression
            self.expressionType = expressionType
            self.inputSerialization = inputSerialization
            self.outputSerialization = outputSerialization
    ...
    internal struct ServerSideEncryptionRule: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        internal init(applyServerSideEncryptionByDefault: ServerSideEncryptionByDefault? = nil, bucketKeyEnabled: Bool? = nil) {
    ...
    internal struct SourceSelectionCriteria: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        internal init(replicaModifications: ReplicaModifications? = nil, sseKmsEncryptedObjects: SseKmsEncryptedObjects? = nil) {
    ...
    internal struct TopicConfiguration: AWSEncodableShape & AWSDecodableShape {
        ...
        @inlinable
        internal init(events: [Event], filter: NotificationConfigurationFilter? = nil, id: String? = nil, topicArn: String) {
            self.events = events
            self.filter = filter
            self.id = id
    ...
    internal struct UploadPartCopyOutput: AWSDecodableShape {
        ...
        @inlinable
        internal init(bucketKeyEnabled: Bool? = nil, copyPartResult: CopyPartResult, copySourceVersionId: String? = nil, requestCharged: RequestCharged? = nil, serverSideEncryption: ServerSideEncryption? = nil, sseCustomerAlgorithm: String? = nil, sseCustomerKeyMD5: String? = nil, ssekmsKeyId: String? = nil) {
            self.bucketKeyEnabled = bucketKeyEnabled
    ...
    internal struct UploadPartOutput: AWSDecodableShape {
        ...
        @inlinable
        internal init(bucketKeyEnabled: Bool? = nil, checksumCRC32: String? = nil, checksumCRC32C: String? = nil, checksumSHA1: String? = nil, checksumSHA256: String? = nil, eTag: String? = nil, requestCharged: RequestCharged? = nil, serverSideEncryption: ServerSideEncryption? = nil, sseCustomerAlgorithm: String? = nil, sseCustomerKeyMD5: String? = nil, ssekmsKeyId: String? = nil) {
            self.bucketKeyEnabled = bucketKeyEnabled
            self.checksumCRC32 = checksumCRC32
            self.checksumCRC32C = checksumCRC32C
            self.checksumSHA1 = checksumSHA1
    ...
    internal struct UploadPartRequest: AWSEncodableShape {
        ...
        @inlinable
        internal init(body: AWSHTTPBody? = nil, bucket: String, checksumAlgorithm: ChecksumAlgorithm? = nil, checksumCRC32: String? = nil, checksumCRC32C: String? = nil, checksumSHA1: String? = nil, checksumSHA256: String? = nil, contentLength: Int64? = nil, contentMD5: String? = nil, expectedBucketOwner: String? = nil, key: String, partNumber: Int, requestPayer: RequestPayer? = nil, sseCustomerAlgorithm: String? = nil, sseCustomerKey: String? = nil, sseCustomerKeyMD5: String? = nil, uploadId: String) {
            self.body = body
            self.bucket = bucket
            self.checksumAlgorithm = checksumAlgorithm
            self.checksumCRC32 = checksumCRC32
