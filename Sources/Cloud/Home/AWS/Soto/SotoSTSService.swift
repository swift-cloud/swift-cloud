...
public struct STS: AWSService {
    ...
    @Sendable
    public func assumeRole(_ input: AssumeRoleRequest, logger: Logger = AWSClient.loggingDisabled) async throws
        -> AssumeRoleResponse
    {
    ...
    @Sendable
    public func assumeRoleWithSAML(_ input: AssumeRoleWithSAMLRequest, logger: Logger = AWSClient.loggingDisabled)
    ...
    public func assumeRoleWithWebIdentity(
        _ input: AssumeRoleWithWebIdentityRequest, logger: Logger = AWSClient.loggingDisabled
    ...
    public func decodeAuthorizationMessage(
        _ input: DecodeAuthorizationMessageRequest, logger: Logger = AWSClient.loggingDisabled
    ) async throws -> DecodeAuthorizationMessageResponse {
        return try await self.client.execute(
    ...
    @Sendable
    public func getAccessKeyInfo(_ input: GetAccessKeyInfoRequest, logger: Logger = AWSClient.loggingDisabled)
        async throws -> GetAccessKeyInfoResponse
    {
        return try await self.client.execute(
    ...
    @Sendable
    public func getCallerIdentity(_ input: GetCallerIdentityRequest, logger: Logger = AWSClient.loggingDisabled)
    ...
    @Sendable
    public func getFederationToken(_ input: GetFederationTokenRequest, logger: Logger = AWSClient.loggingDisabled)
    ...
    @Sendable
    public func getSessionToken(_ input: GetSessionTokenRequest, logger: Logger = AWSClient.loggingDisabled)
